...
# ------Title------------
st.markdown(f'''<h1><i class="bi bi-bar-chart-line" style="font-size:40px"></i> HotSpot Mapping Dashboard</h1>''', unsafe_allow_html=True)
# '---'
...
with col2:
    ...
    # the arrays
    kpi = [total_entries, tba_entries, current_entries, retrospective_entries]
    ...
    # calling the method
    st.markdown(card_kpis(kpi, title, font), unsafe_allow_html=True)
...
with tab2:
    spacer(2)
    trendchart(filtered_df, 'date_of_entry', 'type_of_structural_driver')
